            ...
            <div className="flex items-center justify-between px-6 py-3 bg-white/70 backdrop-blur-lg border border-white/40 shadow-lg rounded-full transition-all duration-300 hover:shadow-xl">
                <div className="flex items-center gap-3">
                    ...
                    <span className="font-semibold text-gray-800 text-lg">
                        <span className="text-green-800">Parayaam </span> <span className="text-green-700">Ariyam</span>
                    </span>
                </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button className="bg-green-600 text-white px-4 py-1.5 rounded-full text-sm hover:bg-green-700 transition">
                        Sign Up
                    </button>
                </div>
