                ...
                <div className="flex-1 border-2 border-dotted border-green-500/30 rounded-[2.5rem] flex flex-col relative bg-white overflow-hidden p-6 md:p-12">
                    ...
                    <div className="shrink-0 mb-6 z-10">
                        <div className="relative group">
                            <input type="text" placeholder="Give your story a title..." value={title} onChange={(e) => setTitle(e.target.value)} className="w-full text-3xl md:text-4xl font-black text-slate-950 bg-transparent outline-none placeholder-slate-200 tracking-tight" />
                    ...
                    <div className="flex-1 overflow-y-auto custom-scrollbar relative z-10">
                        <textarea placeholder="Drafting your masterpiece here..." value={content} onChange={(e) => setContent(e.target.value)} className="w-full h-full min-h-full text-slate-700 text-xl md:text-2xl leading-[1.8] bg-transparent outline-none resize-none placeholder-slate-200 font-medium" />
                    </div>
                    <div className="shrink-0 pt-6 flex justify-end items-center gap-4 z-20">
                        ...
                        <button onClick={onSubmit} disabled={loading || !title || !content} className="px-10 py-4 bg-slate-900 text-white rounded-2xl font-black text-lg hover:bg-green-600 transition-all active:scale-95 disabled:opacity-20 shadow-2xl shadow-slate-200 flex items-center gap-3 group">
