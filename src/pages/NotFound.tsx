        ...
        <div className="h-screen bg-white text-slate-800 font-sans selection:bg-green-100 flex flex-col overflow-hidden">
            ...
            <main className="flex-1 pt-24 pb-8 px-4 md:px-8 w-full flex flex-col overflow-hidden">
                <div className="flex-1 border-2 border-dotted border-green-500/30 rounded-[3rem] relative bg-white flex flex-col items-center justify-center overflow-hidden">
                    <div
                        className="absolute inset-0 flex items-center justify-center text-green-50 pointer-events-none -z-10 transition-transform duration-500 ease-out"
                        style={calcPos(50)}
                    >
                    ...
                    <div
                        onMouseEnter={teleportInk}
                        className="absolute w-12 h-12 flex items-center justify-center cursor-help transition-all duration-300 ease-in-out z-30"
                        style={{ top: inkPos.top, left: inkPos.left }}
                    >
                    ...
                    <div className="relative z-10 text-center px-6">
                        <div className="group relative">
                            <h1 className="text-[100px] md:text-[180px] font-black text-slate-950 leading-none tracking-tighter">
                                404
                            </h1>
                        ...
                        <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
                            <button
                                onClick={() => navigate(-1)}
                                className="px-8 py-3 bg-white border-2 border-slate-100 text-slate-700 rounded-xl font-bold hover:border-green-300 transition-all active:scale-95"
                            >
                                Go Back
                            </button>
                            <Link
                                to="/"
                                className="px-8 py-3 bg-slate-900 text-white rounded-xl font-bold hover:bg-green-600 transition-all shadow-xl shadow-slate-200 active:scale-95"
                            >
                                Home
                            </Link>
                        </div>
                    ...
                    {/* Floating Doodles */}
                    <div
                        className="absolute bottom-10 left-10 text-green-200 hidden lg:block transition-transform duration-700 ease-out"
                        style={calcPos(20)}
                    >
